import React, { createRef, ReactChild, ReactFragment, RefObject, useMemo, useRef, useState, } from 'react';
    ...
    <>
        ...
        <div style={{ textAlign: 'left' }}>
            ...
            <Button variant="primary" onClick={() => {
                axios.post('https://posan-web.vercel.app/communitywrite', {
                    title: title,
                    contents: values,
                    ...
                    if (result.data['state'] === '잘못된 접근') {
                        ...
                        navigate(`/community/view/${result.data['id']}`);
                    }
                });
            }}>글 작성</Button>
        </div>
